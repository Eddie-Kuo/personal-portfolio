      ...
      <main className='h-screen flex flex-col items-center sm:pt-10 bg-light'>
        <div className='max-w-7xl p-5'>
          <motion.h3
            ...
            className='uppercase tracking-[20px] text-xl font-bold text-center'
          >
            About Me
          </motion.h3>
          <div className='flex flex-col md:flex-row items-center gap-10 w-full p-3 max-w-6xl sm:mt-5'>
            ...
            >
              ...
              user experience. <br /> What first intrigued me about tech was the
              power we are given as users. All the information in the world
              rests right in the palm of our hands. Now as the developer, I have
              made it my goal to create applications that will in hopes,
          ...
          <motion.h3
            ...
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 1.5 }}
            className='uppercase tracking-[20px] text-xl font-bold text-center mt-10'
          >
            Tech Stack
          </motion.h3>
