          ...
          <div className='z-10'>
            ...
            <div className='pt-5'>
              <Link
                ...
                className='px-6 py-2 my-1 hover:border border-darkRings rounded-full uppercase text-sm tracking-widest text-darkText dark:text-light transition-all hover:text-highlight/60'
                target='_blank'
              >
                Resume
              </Link>
              ...
              <Link
                ...
                className='px-6 py-2 my-1 hover:border hover:border-darkRings rounded-full uppercase text-sm tracking-widest text-darkText dark:text-light transition-all hover:text-highlight/60'
              >
                Contact
              </Link>
            </div>
